...
class DummyVecEnv(VecEnv):
    ...
    def step_wait(self) -> VecEnvStepReturn:
        ...
        for env_idx in range(self.num_envs):
            ...
            step_results = self.envs[env_idx].step(self.actions[env_idx])
            if len(step_results) == 5:
                obs, self.buf_rews[env_idx], terminated, truncated, self.buf_infos[env_idx] = step_results
            else:
                obs, reward, cost, terminated, truncated, self.buf_infos[env_idx] = step_results
                self.buf_rews[env_idx] = reward - cost

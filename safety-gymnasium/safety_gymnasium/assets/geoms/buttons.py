...
class Buttons(Geom):  # pylint: disable=too-many-instance-attributes
    ...
    locations: list = field(default_factory=lambda: [[1, 1], [-1, -1], [1, -1], [-1, 1]])
    ...
    def cal_cost(self):
        ...
        # print("HERE", cost['cost_buttons'])
        self.last_cost_buttons = cost['cost_buttons']

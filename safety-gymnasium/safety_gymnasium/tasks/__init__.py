...
from safety_gymnasium.tasks.safe_navigation.button.button_level3 import ButtonLevel3
...
from safety_gymnasium.tasks.safe_navigation.goal.goal_level_custom import GoalLevel6, GoalLevel7, GoalLevel8, GoalLevel9, GoalLevel3
